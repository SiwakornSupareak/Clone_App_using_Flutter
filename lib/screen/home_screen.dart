import 'package:clone_web/component/notipage.dart';
import 'package:clone_web/component/recpage.dart';
import 'package:clone_web/component/reelspage.dart';
import 'package:flutter/material.dart';
import 'package:clone_web/component/contactpage.dart';
import 'package:clone_web/component/explorepage.dart';
import 'package:clone_web/component/postcard.dart';
import 'package:clone_web/component/storyicon.dart';
import 'package:clone_web/component/myprofile.dart';
...
class _InstagramHomePageState extends State<InstagramHomePage> {
  ...
  final List<Widget> pages = [
    const HomeScreen(),
    const SearchPage(), // Ensure you define this widget
    const ExplorePage(),
    const ReelsPage(),
    ContactPage(),
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20.0, width: 350,),
              ElevatedButton(
                onPressed: () {
                  Navigator.of(context).pop();
                },
        ...
        children: [
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              const caption = 'Caption for post goes here.';
